...
export default function KontrollørScreen({ params }) {
    const user = params.user;
    const userData = params.userData;
    const handleLogOut = params.handleLogOut;

    const handleScan = () => {
        Alert.alert('Type: \' Brandsikre bukser\', varenr: 6329. \n 22/65 vaske registreret. \n Status: Aktiv');
    };

    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.title}>Kontrollør Screen</Text>
            </View>
